...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    self.reachability = [KSReachability reachabilityToHost:@"www.google.es"];
    ...
    self.reachability.onReachabilityChanged = ^(KSReachability* reachability)
    {
        ...
        UISplitViewController *svc = (UISplitViewController*)weakSelf.window.rootViewController;
        UINavigationController *nc = [svc.viewControllers lastObject];
        if (!reachability.reachable)
            [[DPNotify sharedNotify] showNotifyInView:[nc topViewController].view title:@"No internet connection" dismissOnTap:YES];
    };
